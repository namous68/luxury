 ...
 */
final class Version20230925112501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate ADD user_id INT NOT NULL, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate ADD user BIGINT NOT NULL, DROP user_id');
    }
}
